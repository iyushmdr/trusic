...
include("./components/RecommendationSystem.php");
...
// Initialize the recommendation xsystem
...
// Get recommendations
$recommendations = $recommender->getSessionBasedRecommendations(5);
$currentSongId = isset($_GET['song_id']) ? $_GET['song_id'] : null;
$similarSongs = $currentSongId ? $recommender->getSimilarSongs($currentSongId, 5) : [];

// Format songs for JavaScript
$formatSongs = array();
...
<body>
    <div class="login-modal">
        <div class="login-modal__logo">
            <i class="fa-solid fa-mp3-player"></i>
            <h2>TRUSIC</h2>
        </div>
